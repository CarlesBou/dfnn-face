...
* [*src/explainers/face*](src/dfnn-face/explainers/face): Contains the PyTorch source implementation of the foundational local explainer (FACE).

* [*src/explainers/gface*](src/dfnn-face/explainers/gface): Contains the global explanation framework extension (G-FACE).
